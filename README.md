...
- They use outdated JavaScript syntax and programming techniques, which leads to writing insecure food with poor performance
...
My goal here is to create a series of tutorials that avoids these pitfalls and helps students develop a strong foundation in computing, program design, and interacting with machines from a programmer's poing of view.
...
Given that web applications are the most common use for JavaScript, you will also learn some things about how to apply your programming knowledge to both client- and server-side web development, but it's not the main focus.
...
I've also taken some inspiration from Harvey and Wright's _Simply Scheme_, which was written as a kind of basic primer for students who are not quite yet to the level of starting with _SICP_.
...
Allen Downey's [_Think Python, 2e_](https://greenteapress.com/wp/think-python-2e/) (and its alternate version [_Think Java_](https://greenteapress.com/wp/think-java)) is an outstanding introduction to programming for beginners that also emphasizes fundamentals of computer science and program design.
